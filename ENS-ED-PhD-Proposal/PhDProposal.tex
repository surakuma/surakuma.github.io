...
\emph{This PhD thesis will be held in the ROMA Inria team at LIP, ENS Lyon under the supervision of Suraj Kumar and Loris Marchal. We will also collaborate with neural network experts Elisa Riccietti (LIP),  Rémi Gribonval (LIP) and  Julia Gusak (Inria Bordeaux), and tensor computation expert Bora Uçar (LIP). We have initiated discussions on the proposed topic.}
...
The candidate contacted me (Suraj Kumar) on 29-April-2024 via email. I took his interview over a video call in the first week of May. I found that he is familiar with deep learning models and has good understanding of tensor computations and optimization methods. He seems a perfect candidate for the proposed PhD position. 

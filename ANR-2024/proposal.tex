...
\newcommand*{\titleSK}{\begingroup 
	...
	\begin{mdframed}[roundcorner=10pt,linewidth=1pt,leftmargin=10,rightmargin=10,shadow=true]%
		...
		{\normalsize AAPG 2024 / JCJC 48 months}
...
%%	It is therefore necessary to work with patterns of the tensor data. Finding low dimensional structure of high dimensional data is a powerful approach in this context. Most tensor representations are based on low dimensional structure of the tensors.

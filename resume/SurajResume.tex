...
Low-rank approximations, Deep neural networks, Matrix and tensor computations, Parallel algorithms
%Tensor ComputationsCommunication CostsParallel sAlgorithmsScheduling
...
\begin{itemize}
	\item \ressubheading{{Inria Lyon}}{Lyon, France}{{ISFP (Junior Researcher)}}{Oct 2022 -- present} \newline
...
\begin{enumerate}
	\item *Brief Announcement: Minimizing Communication for Parallel Symmetric Tensor Times Same Vector Computation\\
	Hussam Al Daas, Grey Ballard, Laura Grigori, Suraj Kumar, Kathryn Rouse, Mathieu Vérité\\
	ACM Symposium on Parallelism in Algorithms and Architectures (\textit{SPAA 2025}), Jul 2025, Portland, Oregon, USA.
	...
	ACM Transactions on Parallel Computing (\textit{TOPC}), 2025, Volume 12, Issue 2.
...
\resheading{Teaching}
\begin{itemize}
	\item Master2 course: \href{https://suraj.gitlabpages.inria.fr/rac/home.html}{Resource-aware computations on CPUs and GPUs} (Fall 2025)
	\item Master2 course: \href{https://surakuma.github.io/courses/daamtc.html}{Data-aware algorithms for matrix and tensor computations} (Fall 2023, Fall 2024)
\end{itemize}
...
\begin{itemize}
	\item Reviewer for the following conferences: SC 2025, SC 2024, ICPP 2022

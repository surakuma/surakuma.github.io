...
\pgfplotstableread[col sep=comma]{plots/data/nystrom_cpu_500.csv}\datafile
...
\begin{axis}[\nystromCPUrankFiveH
    ...
    \pgfplotsset{cycle list={black, fill=color5 \\ black, fill=color4 \\ black, fill=color9 \\ black, fill=color4 \\ black, fill=color6 \\ black, fill=color6 \\ black, fill=color7 \\ black, fill=color8 \\ black, fill=color9 \\}}
    ...
    \iflegend
    	\legend{All2All,ReduceScatter,Unpack};
    \fi
  \end{axis}

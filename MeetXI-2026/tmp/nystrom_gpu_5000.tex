...
\pgfplotstableread[col sep=comma]{plots/data/nystrom_gpu_5000.csv}\datafile
...
\begin{axis}[\nystromGPUrankFiveT
    ...
    minor tick num=5
        ...
        \pgfplotsset{cycle list={black, fill=color5 \\ black, fill=color4 \\ black, fill=color9 \\ black, fill=color4 \\ black, fill=color5 \\ black, fill=color9 \\}}
    ...
    \iflegend
    	%\legend{ All2All, Reduce scatter, Unpack};
    \fi
  \end{axis}
\end{tikzpicture}

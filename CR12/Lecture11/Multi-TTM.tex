...
\begin{frame}{Final assignment -- deadline Oct 26}
	\vfill
...
Here $p=p_1p_2p_3$ and $q=q_1q_2q_1$. The algorithm is communication optimal when we select $p_i$ and $q_i$ based on lower bounds.
...
\begin{frame}{Multi-TTM cost in TuckerMPI library}
	...
	\begin{itemize}
		...
		\item Implement ST-HOSVD algorithm -- employs TTM-in-sequence approach to perform Multi-TTM

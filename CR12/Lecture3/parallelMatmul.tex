...
\begin{document}
	...
	\begin{frame}{Some teams in France who work on data-aware algorithms/computations}
		\begin{itemize}
			...
			\vfill
			\item TOPAL team (\url{https://team.inria.fr/hiepacs}), STORM team (https://team.inria.fr/storm), Inria Bordeaux
			\vfill
			\item CAMUS team (https://team.inria.fr/camus), Strasbourg (Part of Inria Nancy)
		\end{itemize}
	\end{frame}

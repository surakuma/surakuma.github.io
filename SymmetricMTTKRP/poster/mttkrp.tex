...
\title{Minimizing Communication for Parallel Symmetric Matricized-Tensor Times Khatri-Rao Product}
...
\begin{block}{Existing work on symmetric matrix computations}
